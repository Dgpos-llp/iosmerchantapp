...
class _AllItemConsumReportPageState extends State<AllItemConsumReportPage> {
  ...
  final List<_Col> _allColumns = [
    ...
    const _Col('Comp Qty', 'complimentaryQty'),
    ...
    const _Col('Disc Amount', 'discountAmount'),
  ...
  Future<void> _exportExcel() async {
    ...
    if (kIsWeb) {
      ...
      final String path = '${Directory.current.path}/ItemConsumReport.xlsx';
    ...
    return SidePanel(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text("Item Consumption Report", style: TextStyle(fontSize: 22, fontWeight: FontWeight.w600, color: Color(0xFF2C3E50))),
  ...
  Widget _buildTable(double screenWidth) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Container(padding: const EdgeInsets.all(16), decoration: BoxDecoration(border: Border(bottom: BorderSide(color: Colors.grey.shade200))), child: const Text("Consumption Details", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF2C3E50)))),
      Expanded(
        child: Scrollbar(
