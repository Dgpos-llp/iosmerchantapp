...
class _AllCancelKotReportPageState extends State<AllCancelKotReportPage> {
  ...
  Future<void> _exportExcel() async {
    try {
      ...
      if (kIsWeb) {
        web_exporter.saveFileWeb(fileBytes!, 'CancelKotReport.xlsx');
        if (mounted) {
        ...
        final String path = '${directory.path}/CancelKotReport_${DateTime.now().millisecondsSinceEpoch}.xlsx';
    ...
    return SidePanel(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text("Cancel KOT", style: TextStyle(fontSize: 22, fontWeight: FontWeight.w600, color: Color(0xFF2C3E50))),
  ...
  Widget _buildBreadcrumb() {
    return Container(
      ...
      child: Row(children: [
        ...
        const Text("Cancel KOT", style: TextStyle(color: Color(0xFF4154F1), fontWeight: FontWeight.w600, fontSize: 13)),
      ]),
    );
  }
  ...
  Widget _buildTable(bool isMobile) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Container(
          ...
          child: const Text("Cancelled KOTs", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF2C3E50)))
      ),
      Expanded(
        child: Scrollbar(
