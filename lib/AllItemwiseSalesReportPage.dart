...
class _AllItemwiseSalesReportPageState extends State<AllItemwiseSalesReportPage> {
  ...
  final List<_Col> _allColumns = const [
    ...
    _Col('Product', 'productName'),
    _Col('Code', 'productCode'),
    _Col('Qty', 'totalQntSold'),
    _Col('Amount', 'totalSaleAmount'),
  ];
  ...
  Future<void> _exportExcel() async {
    try {
      ...
      if (kIsWeb) {
        ...
        final String path = '${directory.path}/ItemwiseSalesReport_${DateTime.now().millisecondsSinceEpoch}.xlsx';
  ...
  Widget _buildTable(bool isMobile) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Container(
          ...
          child: const Text("Itemwise Summary", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF2C3E50)))
      ),
      Expanded(
        child: Scrollbar(
