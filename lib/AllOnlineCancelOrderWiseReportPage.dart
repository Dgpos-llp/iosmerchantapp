...
class _AllOnlineCancelOrderWiseReportPageState extends State<AllOnlineCancelOrderWiseReportPage> {
  ...
  final List<_Col> _allColumns = [
    ...
    const _Col('Source', 'orderFrom'),
    const _Col('Order No', 'onlineOrderId'),
    const _Col('Item', 'itemName'),
    const _Col('Qty', 'quantity'),
    const _Col('Price', 'unitPrice'),
    const _Col('Item Gross', 'itemGrossTotal'),
    const _Col('Order Gross', 'orderGrossTotal'),
    const _Col('Total', 'totalAmount'),
  ];
  ...
  Future<void> _exportExcel() async {
    try {
      ...
      if (kIsWeb) {
        ...
        final String path = '${directory.path}/OnlineCancelOrderReport_${DateTime.now().millisecondsSinceEpoch}.xlsx';
    ...
    return SidePanel(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text("Online Cancel Order", style: TextStyle(fontSize: 22, fontWeight: FontWeight.w600, color: Color(0xFF2C3E50))),
  ...
  Widget _buildBreadcrumb() {
    return Container(
      ...
      child: Row(children: [
        ...
        const Text("Online Cancel", style: TextStyle(color: Color(0xFF4154F1), fontWeight: FontWeight.w600, fontSize: 13)),
      ]),
    );
  }
  ...
  Widget _buildTable(bool isMobile) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Container(
          ...
          child: const Text("Cancellation Details", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF2C3E50)))
      ),
      Expanded(
        child: Scrollbar(
...
class _OnlineCancelOrderRow {
  ...
  factory _OnlineCancelOrderRow.fromReport({required OnlineCancelOrderReport report, required String restaurant}) {
    ...
    return _OnlineCancelOrderRow(
        ...
        quantity: f3(report.quantity),
        unitPrice: f3(report.unitPrice),
        itemGrossTotal: f3(report.itemGrossTotal),
        orderGrossTotal: f3(report.orderGrossTotal),
        totalAmount: f3(report.totalAmount)
    );
  }
