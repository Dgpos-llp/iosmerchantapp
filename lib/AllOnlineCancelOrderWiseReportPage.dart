...
class _AllOnlineCancelOrderWiseReportPageState extends State<AllOnlineCancelOrderWiseReportPage> {
  ...
  _OnlineCancelOrderRow get totalRow {
    ...
    return _OnlineCancelOrderRow(
      ...
      onlineOrderId: "",
      itemName: "",
      // Quantity sum formatted to 3 decimal places
  ...
  Future<void> _exportExcel() async {
    ...
    if (kIsWeb) {
      web_exporter.saveFileWeb(fileBytes!, 'AllOnlineCancelOrderWiseReport.xlsx');
  ...
  Widget _dropdownFilter(
      String label, List<String> dbKeys, String selectedDbKey, ValueChanged<String?> onChanged, Map<String, String> dbKeyToBrand) {
...
class _OnlineCancelOrderRow {
  ...
  factory _OnlineCancelOrderRow.fromReport({required OnlineCancelOrderReport report, required String restaurant}) {
    return _OnlineCancelOrderRow(
      ...
      quantity: report.quantity.toStringAsFixed(3),
      unitPrice: report.unitPrice.toStringAsFixed(3),
      itemGrossTotal: report.itemGrossTotal.toStringAsFixed(3),
      orderGrossTotal: report.orderGrossTotal.toStringAsFixed(3),
      totalAmount: report.totalAmount.toStringAsFixed(3),
    );
  }
