    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const Text("Taxwise Sales", style: TextStyle(color: Color(0xFF4154F1), fontWeight: FontWeight.w600, fontSize: 13)),
        ],
      ),
    );
  }
                          ...
                          return Container(
                            ...
                            child: Row(
                              children: _visibleColumns.map((col) => Container(
                                ...
                                child: Text(row.getField(col.key), style: const TextStyle(fontSize: 13, color: Color(0xFF2C3E50))),
                              )).toList(),
                            ),
                          );
                        },
      ...
      child: Row(
        children: _visibleColumns.map((col) {
          ...
          return Container(
            ...
            padding: const EdgeInsets.symmetric(horizontal: 12),
            decoration: BoxDecoration(border: Border(right: BorderSide(color: Colors.grey.shade300))),
            child: Text(displayValue, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Color(0xFF4154F1))),
          );
        }).toList(),
      ),
    );
