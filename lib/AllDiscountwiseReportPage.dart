...
class _AllDiscountwiseReportPageState extends State<AllDiscountwiseReportPage> {
  ...
  final List<_Col> _allColumns = [
    ...
    const _Col('Gross', 'amount'),
    const _Col('Discount', 'discount'),
    const _Col('Net', 'netAmount'),
    const _Col('Disc On', 'discountOnAmt'),
  ...
  bool _isNumeric(String key) {
    return ['amount', 'discount', 'netAmount', 'discountOnAmt'].contains(key);
  }
  ...
  Future<void> _exportExcel() async {
    try {
      ...
      if (kIsWeb) {
        ...
        final String path = '${directory.path}/DiscountwiseReport_${DateTime.now().millisecondsSinceEpoch}.xlsx';
    ...
    return SidePanel(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text("Discountwise", style: TextStyle(fontSize: 22, fontWeight: FontWeight.w600, color: Color(0xFF2C3E50))),
  ...
  Widget _buildBreadcrumb() {
    return Container(
      ...
      child: Row(children: [
        ...
        const Text("Discountwise", style: TextStyle(color: Color(0xFF4154F1), fontWeight: FontWeight.w600, fontSize: 13)),
      ]),
    );
  }
  ...
  Widget _buildTable(bool isMobile) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Container(
          ...
          child: const Text("Discount Details", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF2C3E50)))
      ),
      Expanded(
        child: Scrollbar(
...
class _DiscountwiseRow {
  ...
  factory _DiscountwiseRow.fromReport({required DiscountwiseReport report, required String restaurant}) {
    ...
    return _DiscountwiseRow(
        ...
        amount: f3(report.amount),
        discount: f3(report.discount),
        netAmount: f3(report.netAmount),
        discountOnAmt: f3(report.discountOnAmt),
