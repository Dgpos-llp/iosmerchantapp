...
class _AllPaxWiseReportPageState extends State<AllPaxWiseReportPage> {
  ...
  _PaxWiseRow get totalRow {
    ...
    // Formatting summed quantities and amounts to 3 decimal places
    return _PaxWiseRow(
      restaurant: "Total",
      billDate: "",
  ...
  Future<void> _exportExcel() async {
    ...
    if (kIsWeb) {
      web_exporter.saveFileWeb(fileBytes!, 'AllPaxWiseReport.xlsx');
      ...
      final String path = '${Directory.current.path}/PaxWise.xlsx';
