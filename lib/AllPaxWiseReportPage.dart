    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const Text("Pax Wise Sales", style: TextStyle(color: Color(0xFF4154F1), fontWeight: FontWeight.w600, fontSize: 13)),
        ],
      ),
    );
  }
...
class _PaxWiseRow {
  ...
  factory _PaxWiseRow.fromReport({required PaxWiseReport report, required String restaurant}) {
    ...
    return _PaxWiseRow(restaurant: restaurant, billDate: report.billDate, totalPax: format3(report.totalPax.toString()), totalAmount: format3(report.totalAmount));
  }
