...
class _AllCancelBillReportPageState extends State<AllCancelBillReportPage> {
  ...
  final List<_Col> _allColumns = [
    ...
    const _Col('Created', 'createdTime'),
    const _Col('Cancel Time', 'cancelTime'),
    const _Col('Created By', 'createdUser'),
    const _Col('Cancel By', 'cancelUser'),
    const _Col('Type', 'billType'),
  ...
  Future<void> _exportExcel() async {
    try {
      ...
      if (kIsWeb) {
        ...
        final String path = '${directory.path}/CancellationReport_${DateTime.now().millisecondsSinceEpoch}.xlsx';
    ...
    return SidePanel(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text("Cancellation", style: TextStyle(fontSize: 22, fontWeight: FontWeight.w600, color: Color(0xFF2C3E50))),
  ...
  Widget _buildTable(bool isMobile) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Container(
          ...
          child: const Text("Cancelled Bills", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF2C3E50)))
      ),
      Expanded(
        child: Scrollbar(
