...
class _AllSettlementwiseReportPageState extends State<AllSettlementwiseReportPage> {
  ...
  _SettlementwiseRow get totalRow {
    ...
    return _SettlementwiseRow(
      ...
      billDate: "",
      settlementModeName: "",
      // Formatting total gross amount to 3 decimal places
      grossAmount: sum((r) => r.grossAmount).toStringAsFixed(3),
      // Number of bills usually stays integer (formatted here with 0 decimals)
...
class _SettlementwiseRow {
  ...
  factory _SettlementwiseRow.fromReport({required SettlementwiseReport report, required String restaurant}) {
    // Formatting numbers to 3 decimal places safely
    ...
    return _SettlementwiseRow(
      ...
      grossAmount: format3(report.grossAmount),
      numberOfBills: report.numberOfBills.toString(),
      percentToGross: format3(report.percentToGross),
    );
  }
