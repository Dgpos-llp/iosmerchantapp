...
class _AllSettlementwiseReportPageState extends State<AllSettlementwiseReportPage> {
  ...
  final List<_Col> _allColumns = [
    ...
    const _Col('Settlement', 'settlementModeName'),
    const _Col('Gross', 'grossAmount'),
    const _Col('Bills', 'numberOfBills'),
    const _Col('%', 'percentToGross'),
  ];
  ...
  bool _isNumeric(String key) {
    return ['grossAmount', 'numberOfBills', 'percentToGross'].contains(key);
  }
  ...
  Future<void> _exportExcel() async {
    try {
      ...
      if (kIsWeb) {
        ...
        final String path = '${directory.path}/SettlementwiseReport_${DateTime.now().millisecondsSinceEpoch}.xlsx';
    ...
    return SidePanel(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text("Settlementwise", style: TextStyle(fontSize: 22, fontWeight: FontWeight.w600, color: Color(0xFF2C3E50))),
  ...
  Widget _buildBreadcrumb() {
    return Container(
      ...
      child: Row(children: [
        ...
        const Text("Settlementwise", style: TextStyle(color: Color(0xFF4154F1), fontWeight: FontWeight.w600, fontSize: 13)),
      ]),
    );
  }
  ...
  Widget _buildTable(bool isMobile) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Container(
          ...
          child: const Text("Settlement Details", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF2C3E50)))
      ),
      Expanded(
        child: Scrollbar(
...
class _SettlementwiseRow {
  ...
  factory _SettlementwiseRow.fromReport({required SettlementwiseReport report, required String restaurant}) {
    ...
    return _SettlementwiseRow(
        ...
        grossAmount: f3(report.grossAmount),
        numberOfBills: report.numberOfBills.toString(),
        percentToGross: f3(report.percentToGross)
    );
  }
  ...
  dynamic getField(String k) {
    switch (k) {
      ...
      case 'numberOfBills': return numberOfBills;
      case 'percentToGross': return percentToGross;
      default: return '';
    }
  }
}
