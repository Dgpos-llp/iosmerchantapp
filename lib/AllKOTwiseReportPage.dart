...
class _AllKOTwiseReportPageState extends State<AllKOTwiseReportPage> {
  ...
  final List<_Col> _allColumns = [
    ...
    const _Col('Operation', 'operation'),
  ...
  Map<String, dynamic> get totalRow {
    return {
      ...
      'time': '',
      'billNo': '',
      'qty': totalQty.toStringAsFixed(3),
      'tableNumber': '',
      'waiter': '',
      'reason': '',
      'product': '',
  ...
  Future<void> _exportExcel() async {
    try {
      ...
      for (int i = 0; i < _visibleColumns.length; i++) {
        ...
        else if (colKey == 'qty') value = totalQty.toStringAsFixed(3);
      ...
      if (kIsWeb) {
        ...
        final String path = '${directory.path}/KOTAnalysisReport_${DateTime.now().millisecondsSinceEpoch}.xlsx';
    ...
    return SidePanel(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text("KOT Analysis", style: TextStyle(fontSize: 22, fontWeight: FontWeight.w600, color: Color(0xFF2C3E50))),
  ...
  // UPDATED: Table with responsive column widths and totals row
  Widget _buildTable(bool isMobile) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Container(
          ...
          child: const Text("KOT Details", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF2C3E50)))
      ),
      Expanded(
        child: Scrollbar(
                            ...
                            children: _visibleColumns.map((col) {
                              ...
                              return Container(
                                ...
                                child: isProduct
                                    ...
                                    children: row.product.split(',').map((e) => Text(
                                      e.trim(),
                                      style: const TextStyle(fontSize: 10, height: 1.3, color: Color(0xFF2C3E50)),
                                      overflow: TextOverflow.ellipsis,
                                      maxLines: 1,
                                    )).toList()
                                )
  ...
  Widget _buildTotalRow(double h, double w) {
    return Container(
      ...
      child: Row(children: _visibleColumns.map((col) {
        ...
        else if (col.key == 'qty') text = totalQty.toStringAsFixed(3);
